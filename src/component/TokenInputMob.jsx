 ...
 */
const TokenInputMob = ({ label, onChange, onTokenChange, selectedToken, defaultValue, tokenOptions, inputRef, decimals = 6, ...others }) => {
	...
	return (
		<div {...others} className="bg-[#000000] p-2 gap-2 flex relative z-[9] justify-between items-center rounded-[8px] isolate">
			<div className="flex-1 flex flex-col">
				<h5 className="text-[#fff] text-[9px] font-[600]">
					{label}
				</h5>
				<input
					type="text"
					className="text-[#fff] w-[73px] text-[11px] font-[700] bg-[transparent] outline-none flex-1"
					value={valStr}
					size={1}
					onFocus={(e) => {
			...
			{selectedToken && (
				<div className="relative inline-block text-left z-[9] flex-shrink-0">
					<div
						className={clsx(
							"flex items-center justify-between space-x-1 px-2 rounded-full border-[0.8px] border-[#8ED0FF3A] bg-[#0077D64A]",

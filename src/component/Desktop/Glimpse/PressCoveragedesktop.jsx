            ...
            <SwiperSlide>
              <div className="flex flex-row items-center gap-[100px]">
                ...
                <div className="flex flex-col gap-8">
                  <h3 className="w-[720px] font-[RFDewiExtended] text-[45px] text-start font-[900] leading-[53px] capitalize">
                    Press Coverage & Features
                  </h3>
                  <h4 className="w-[579px] text-[28px] font-[RFDewiExtended]  text-start font-[700] leading-[36px] capitalize">
                    Innovating Water Solutions: Paul
                    <br /> Mann on the Future of Water Reuse
                  </h4>
                  <p className=" w-[639px] text-[16px] font-[Roboto] leading-[23px]  font-[400] ">
                    Paul Mann shares his groundbreaking approach to water reuse,
                    detailing how sustainable technologies can reduce water
                    consumption by 70%.
                  </p>
                  <button className="w-[120px] block font-[Roboto]  h-[50px] text-[12px] leading-[12px] uppercase tracking-[0.6px] text-center bg-[#FFF] text-[#073B63] hover:bg-[#073B63] hover:text-[#FFF] font-[900]  border border-[#073B63]">
                    Read more
                  </button>
                </div>
              </div>

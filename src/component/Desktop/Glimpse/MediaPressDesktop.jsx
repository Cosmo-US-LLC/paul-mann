      ...
      <div className="max-w-[1200px] py-16 mx-auto flex flex-col justify-center">
        <div className="w-[100%] flex flex-row">
          <div className="flex flex-col justify-center gap-4  w-[50%]">
            <h3 className="text-[45px]  font-[700] font-[RFDewi-Light] leading-[53px] capitalize">
              Media & Press Inquiries
            </h3>
            <p className="w-[463px] text-[16px] leading-[23px] font-[400] ">
          ...
          <div className="px-8 py-8 flex flex-col gap-4 rounded-lg bg-[#027496] w-[50%]  ">
            <h3 className="text-[28px] font-[800] text-[#fff] font-[RFDewi-Light] capitalize">
              Contact Form
            </h3>
            <div className="flex flex-col gap-4">
              ...
              <input
                ...
                className="w-[100%]  py-2 placeholder:opacity-[0.9] border-b border-[#fff] outline-none bg-[#027496] text-[#fff] font-[RFDewi-Light]"
                name=""
                id=""
              />
              <input

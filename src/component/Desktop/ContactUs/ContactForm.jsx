          ...
          <div className="w-full space-y-5 md:w-1/2">
            ...
            <form className="space-y-4">
              <input
                type="text"
                placeholder="Name"
                className="w-full py-2 font-[Roboto] border-b-2 border-gray-400 outline-none focus:border-black"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="px-6 py-2 mt-4 font-semibold font-[Roboto] text-[#073B63] hover:bg-[#073B63] hover:text-[#FFF] border border-[#073B63] bg-white shadow-inner"

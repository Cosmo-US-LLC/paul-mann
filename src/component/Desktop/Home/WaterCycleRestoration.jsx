          ...
          <div className="flex flex-wrap items-start gap-10">
            {solutionsData.map((solution, index) => (
              ...
              >
                ...
                />
                <h4 className="mb-2 tracking-[0.9px] text-[25px] font-[600] leading-[24px] font-[RFDewiExtended]">{solution.title}</h4>
                <p className="text-[16px] font-[400] leading-[20px] font-[Roboto]">{solution.description}</p>
              </div>
            ))}
          </div>

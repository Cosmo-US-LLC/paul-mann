...
function HeroSection() {
  return (
    <div className="relative">
      <img className="absolute inset-0 object-cover w-full h-full" src={'/desktop-assets/hero/hero-bg.webp'} alt="Hero background" />
        ...
        <div className="max-w-[1200px] h-[750px] gap-10 mx-auto flex flex-col justify-center text-white">
          <div className="relative z-10 flex flex-col justify-end h-full gap-10 py-10 text-white">
            ...
            <div className="flex items-center gap-10">
              <p className="text-[16px] font-[Roboto] font-[500] leading-[24px] uppercase">follow Paul :</p>
              <div className="flex gap-8">
                <a href="#" className="hover:text-gray-300">
                  <img className="object-cover h-6" src={'/desktop-assets/hero/logo1.svg'} alt="Facebook Logo" />
                </a>
                <a href="#" className="hover:text-gray-300">
                  <img className="object-cover h-6" src={'/desktop-assets/hero/logo2.svg'} alt="Twitter Logo" />
                </a>
                <a href="#" className="hover:text-gray-300">
                  <img className="object-cover h-6" src={'/desktop-assets/hero/logo3.svg'} alt="Instagram Logo" />
                </a>
                <a href="https://www.linkedin.com/in/pauldmann/" className="hover:text-gray-300">
                  <img className="object-cover h-6" src={'/desktop-assets/hero/logo4.svg'} alt="LinkedIn Logo" />
                </a>
                <a href="#" className="hover:text-gray-300">
                  <img className="object-cover h-6" src={'/desktop-assets/hero/logo5.svg'} alt="YouTube Logo" />
                </a>
              </div>
            </div>
          </div>

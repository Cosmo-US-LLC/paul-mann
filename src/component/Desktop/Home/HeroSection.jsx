  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      <video
        ...
        src="/video/hero-video.mp4"   // ✅ Make sure the path is correct
        autoPlay
        muted
        loop
        playsInline
      ...
      <button
        ...
        className="absolute z-10 px-4 py-2 text-sm text-white bg-black rounded-full shadow-lg bottom-8 left-8 bg-opacity-60"
      >
